...
public class SimulationController {
    ...
    public void run(int numCoresP0,
        ...
        processorP0 = new Processor(0, numCoresP0, numCachesP0, 30, slowMode, "DatosHilillos/P0", memory0, initializeInstructionMemory(0));
        processorP1 = new Processor(1, numCoresP1, numCachesP1, 30, slowMode, "DatosHilillos/P1", memory1, initializeInstructionMemory(1));
