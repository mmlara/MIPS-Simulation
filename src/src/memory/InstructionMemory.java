...
public class InstructionMemory {
    ...
    public void loadInstructionsInMemory(Queue<Hilillo> hilillos){
        int index=0;//lleva el indíce de la instrucción que se va llenando en memoria;
        for (Hilillo hilillo : hilillos) {
            hilillo.setInitIndexInMemory(index);
            List<Instruction> instructions= hilillo.getMyInstructions();
            ...
            hilillo.setLastIndexInMemory(index);//este demarca donde empieza el siguiente
        }
    }
}
